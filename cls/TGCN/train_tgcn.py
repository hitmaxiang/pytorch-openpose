...
from datasetcreate import PoseDataset

os.environ['CUDA_VISIBLE_DEVICES'] = '0'


def run(motionfilepath, samplefilepath, configs, featuremode, save_model_to=None):
    ...
    # setup dataset
    train_dataset = PoseDataset(motionfilepath, samplefilepath, 'train', featuremode, num_samples)
    ...
    val_dataset = PoseDataset(motionfilepath, samplefilepath, 'test', featuremode, num_samples)
